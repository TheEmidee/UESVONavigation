...
The last option allows you to run a CatmullRom Algorithm on the points generated by the pathfinding to smooth it out. You can use the `Smoothing Subdivisions` to make control the smoothness.
